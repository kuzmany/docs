...
---
import { Card, CardGroup, Note, Steps } from '@mintlify/components';
...
<iframe src="https://www.motionshot.app/walkthrough/68000c8386600ed657496baf/embed?hideSteps=1&hideAsSteps=1&hideDownload=1&hideCopy=1&fullscreen=1" width="100%" style='border: 1px solid rgba(0,0,0,0.16); border-radius: 20px; min-height: 740px' ></iframe>
